...
namespace JaskiniaGier.Migrations
{
    ...
    [Migration("20200131114647_UpdateGameDescriptions")]
            ...
            modelBuilder.Entity("JaskiniaGier.Models.Entities.Game", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            GameId = 7,
                            GameDescription = "Azeroth zapłacił ogromną cenę za niszczycielską krucjatę Płonącego Legionu, która została przedstawiona w poprzednim dodatku do gry. W chwili gdy świat powoli leczy rany zagrożeniem staje się rosnący brak zaufania pomiędzy Przymierzem i Hordą, które ponownie roznieca wrogość pomiędzy oboma stronnictwami. Jednym ze źródeł konfliktu jest do dostęp do nowego i cudownego magicznego minerału o Azerite. W trakcie zabawy gracze są świadkami tragicznych wydarzeń doprowadzających do kolejnej wojny oraz wytyczenia nowych granic, frontów i sojuszy, które zdecydują o przyszłości Azeroth.",
                            ImagePath = "wow.jpg",
                            Price = "170,00 zł",
                            SubGenreId = 3,
